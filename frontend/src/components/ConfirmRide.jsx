...
function ConfirmRide(props) {
  ...
  if (props.vehicleType === "car") {
    ...
    vehicleImage = "https://d1a3f4spazzrp4.cloudfront.net/car-types/haloProductImages/v1.1/Uber_Moto_India1.png"; // Moto image (replace with actual URL)
  } else if (props.vehicleType === "auto") {
    vehicleImage = "https://d1a3f4spazzrp4.cloudfront.net/car-types/haloProductImages/v1.1/TukTuk_Green_v1.png"; // Auto image (replace with actual URL)
  } else {
    ...
    <div>
      ...
      <div className="flex gap-2 justify-between items-center flex-col ">
        ...
        <button
          ...
          className="w-full bg-green-600 mt-1 text-white font-semibold p-2 rounded-lg"
        >
          Confirm
        </button>
      </div>
